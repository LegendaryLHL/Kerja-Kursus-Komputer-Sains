...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        if ($_POST["isFinish"] == "true") {
            ...
            if (!getKehadiran($pdo, getHari($pdo)['id_hari'], $_SESSION["id"])) {
            ...
            setFinish($pdo, getHari($pdo)['id_hari'], $_SESSION["id"], $datetime);
        ...
        if ($errors) {
            ...
            setKehadiran($pdo, getHari($pdo)['id_hari'], $_SESSION["id"], $can_work ? 1 : 0);
